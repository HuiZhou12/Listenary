...
- 在线歌词与本地歌词统一播放页的字体、颜色、模糊、发光、透明度、行间距和动效
- 在线歌词支持与本地一致的聚焦定位、边缘渐隐、平滑/弹簧滚动、拖动后恢复和并行行显示
- 在线歌词恢复播放页歌词设置入口，可调整字号、粗细、对齐、模糊、翻译与罗马音等显示选项
- 普通 LRC、增强 LRC 和逐词歌词统一时间轴处理，改善在线歌词行切换和短增强歌词识别
- 远程逐词高亮使用在线播放进度，不再读取本地播放位置

**在线播放**

- 远程歌词时间线刷新更及时，暂停、seek 和不同播放状态下的显示更稳定
- 在线歌单排序后的页面顺序与实际播放队列保持一致

**稳定性与兼容性**

- 修复 offset 跨越零点时的歌词时间戳处理
- 增加歌词时间轴、远程行切换和播放页布局回归测试
